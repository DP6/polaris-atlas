...
from atlas.core import event_cache, workspace_directory
from atlas.core.bigquery import get_runtime_project
from atlas.core.config import settings
from atlas.core.exceptions import AccessRequestNotFoundError, LastAdminLockoutError
from atlas.core.run_client import trigger_job_execution
from atlas.domains.admin import project_admin_repository, repository
...
def trigger_event_cache_refresh(
    ...
    *,
    ...
    infra/terraform/modules/cloud-run-job). Sem deduplicação de execuções
    concorrentes na v1: se já houver uma execução em andamento, esta
    apenas soma outra em paralelo.
    ...
    trigger_job_execution(
        ...
        only_projects=projects or None,
    )
